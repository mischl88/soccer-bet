        ...
        <form onSubmit={formik.handleSubmit}>
          <FormControl>
            <ClientOnly>
              ...
              <FormLabel id="password-label" htmlFor="password" ms="4px" fontSize="sm" fontWeight="500"
                         color={textColor}
                         display="flex">
              ...
              <Flex justifyContent="space-between" align="center" mb="24px">
                <FormControl display="flex" alignItems="center">
                  <Checkbox id="rememberMe" colorScheme="brandScheme" me="10px" onChange={formik.handleChange}
